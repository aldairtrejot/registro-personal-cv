                        ...
                        <!--
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a :href="`${BASE_URL}/role/edit/${row.id}`"
                                        class="btn btn-6 btn-vimeo btn-icon shadow-sm" aria-label="Editar">
                                        <i class="ti ti-edit" style="font-size: 1.2rem;"></i>
                                    </a>


                                    <button type="button" class="btn btn-6 btn-rss  btn-icon shadow-sm" aria-label="VK">
                                        <i class="ti ti-lock-open-2" style="font-size: 1.2rem;"></i>
                                    </button>
...
const fetchTableData = async () => {
    ...
    try {
        const { data } = await axios.post('/role/table', {
