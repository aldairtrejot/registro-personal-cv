...
{
    public function contentMail($user, $password, $name)
    {
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr style="background-color:#7b1f32;">
            <td style="padding:20px 30px;">
                ...
                <p style="color:#c9a54b; font-size:14px; margin:5px 0 0;">Alta de nuevo usuario</p>
            </td>
        </tr>
        <tr>
            <td style="padding:30px; color:#333333;">
                <p style="font-size:16px; line-height:1.6;">
                    ¡Hola ' . ucwords(strtolower($name)) . '!, hemos recibido la solicitud para la creación de su usuario. A continuación
                    encontrará los datos de acceso para iniciar su proceso.
                </p>
