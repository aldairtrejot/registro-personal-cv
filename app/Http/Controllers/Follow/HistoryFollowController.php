...
use App\Models\Follow\HistoryFollowModel;
use Illuminate\Http\Request;

class HistoryFollowController extends Controller
{
    public function historyFollow()
    {
        try {
            $historyFollowModel = new HistoryFollowModel();
            $data = $historyFollowModel->historyFollow();
