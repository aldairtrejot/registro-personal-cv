...
use App\Models\Administration\UserEmployee\TableUserEmployeeModel;
use Illuminate\Http\Request;


class TableUserEmployeeController extends Controller
{
    /**
    ...
    public function usertable(Request $request)
    {
        ...
        $objectModel = new TableUserEmployeeModel();     // Create instance of the User model
        try {
